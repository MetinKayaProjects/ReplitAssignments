package homework_rep_it_210_219_____219;

import homework_repl_it.Words_035;
...
public class Book {
    ...
    public static Boolean isTitleWord(String word) {
		if (word.equalsIgnoreCase("a") || word.equalsIgnoreCase("an") || word.equalsIgnoreCase("the") || word.equalsIgnoreCase("and") || word.equalsIgnoreCase("but") 
			|| word.equalsIgnoreCase("for") || word.equalsIgnoreCase("nor") || word.equalsIgnoreCase("or") || word.equalsIgnoreCase("so") || 
			word.equalsIgnoreCase("yet") || word.equalsIgnoreCase("at") || word.equalsIgnoreCase("by") || word.equalsIgnoreCase("in") ||
			word.equalsIgnoreCase("into") || word.equalsIgnoreCase("near") || word.equalsIgnoreCase("of") || word.equalsIgnoreCase("on") ||
			word.equalsIgnoreCase("to") || word.equalsIgnoreCase("than") || word.equalsIgnoreCase("via")){
			return false;
				}
...
//			
			this.author = str.substring(0, str.length()-1);
		}
    ...
    public void setTitle(String title) {
        if (title.isEmpty()) {
			...
			if (strArr.length == 1 ) {
				this.title = capitalize(strArr[0]);
			}else {
				String s = capitalize(strArr[0]) + " ";
				for (int i = 1; i < strArr.length; i++) {
					if (!isTitleWord(strArr[i])) {
						s += strArr[i].toLowerCase() + " ";
					}else {
						s += capitalize(strArr[i]) + " ";
					}
				}
				this.title = s.substring(0, s.length()-1);
			}
		}
     }
