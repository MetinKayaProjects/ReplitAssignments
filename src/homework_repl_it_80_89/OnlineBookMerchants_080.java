...
public class OnlineBookMerchants_080 {
	public static void main(String[] args) {
		 ...
		 * or more books.
		 * 
		 * It offers regular customers 1 free book with every purchase of 7 or more
		 * books, and offers 2 free books with every purchase of 12 or more books.
		 * 
		...
		if(isPremiumCustomer == false) {
			if (nbooksPurchased >= 7 && nbooksPurchased < 12) {
				...
				freeBooks = 2 * (nbooksPurchased / 12);
			}
		}
